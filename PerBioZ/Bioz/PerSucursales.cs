    ...
    public class PerSucursales : Persistencia
    {
        public List<EntSucursal> ObtenerTodos()
        {
            ...
            try
            {
                ...
                var sql = "SELECT id_sucursal, desc_sucursal,id_empresa FROM informix.sucursales";
        ...
        public EntSucursal Obtener(int id)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT id_sucursal, desc_sucursal,id_empresa FROM informix.sucursales WHERE id_sucursal=?";
