...
namespace BioZ.Controllers.Dispositivo
{
    internal class DeviceManipulator
    {
        ...
        public bool UploadFTPTemplate(ZkemClient objZkeeper, int machineNumber, List<UserInfo> lstUserInfo)
        {
            ...
            int idwFingerIndex = 0,   iFlag = 1, iUpdateFlag = 1;
            int iPrivilege = 0;
            string sPassword = "";
            string sEnabled = "";
            bool bEnabled = false;
        ...
        public object ClearData(ZkemClient objZkeeper, int machineNumber, int clearFlag)
        {
            int iDataFlag = clearFlag;
